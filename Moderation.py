...
client = commands.Bot(command_prefix=commands.when_mentioned_or('?'), intents=discord.Intents.all(),
                      ...
                      pm_help=True, owner_id=684644222615158834,
...
class Moderation(commands.Cog):
    ...
    @client.command(name="slowmode", aliases=['setdelay', 'sm'])
    @commands.guild_only()
    @commands.has_guild_permissions(manage_guild=True)
    ...
    @client.command(aliases=['deafenall', 'disablevc'])
    @commands.guild_only()
    @commands.has_guild_permissions(manage_guild=True)
    ...
    @client.command(aliases=['undeafenall', 'enablevc'])
    @commands.guild_only()
    @commands.has_guild_permissions(manage_guild=True)
