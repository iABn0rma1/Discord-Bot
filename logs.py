...
class logs(commands.Cog, name="Logs", command_attrs=dict(hidden=True)):
    ...
    async def event_error(self, error=None, event=None, guild=None):
        ...
        e = discord.Embed(color=discord.Colour.from_rgb(250,0,0), title=f"<:xmark:784187150542569503> Error occured on event {event}")
        e.description = f"```py\n{tbe}```"
    ...
    async def on_message_edit(self, before, after):
        ...
        embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                              description=f"<:check:784187150660665384> Message edited! [Jump to message]({before.jump_url})",
    ...
    async def on_message_delete(self, message):
        ...
        embed = discord.Embed(
            color=discord.Colour.from_rgb(250,0,0), description=f"<:check:784187150660665384> Message deleted!",
            timestamp=datetime.datetime.now())
    ...
    async def on_member_join(self, member):
        ...
        # ! Temp mute
        temp_mute = await self.bot.db.fetchval("SELECT user_id FROM moddata WHERE user_id = $1 AND guild_id = $2",
                ...
                if temp_mute:
                    ...
                    if muterole:
                        try:
                            ...
                            await self.event_error(error=e, event='on_member_join (anti evading mute)',
                                                   guild=member.guild)
                            pass
                    else:
                        pass
        if db_check2 is not None:
            ...
            embed = discord.Embed(
                color=discord.Colour.from_rgb(250,0,0), description=f"<:members:784814520727240724> New member joined",
                timestamp=datetime.datetime.now())
        ...
        if db_check3 is not None:
            ...
            if db_check3['message'] and not db_check3['embed']:
                ...
                joinmessage = f"<:check:784187150660665384> {member.mention} joined the server! There are {member.guild.member_count} members in the server now."
            ...
            try:
                if db_check3['embed']:
                    try:
                        await welcomechannel.send(content=emb_dict['plainText'],
                                                  embed=discord.Embed.from_dict(emb_dict),
                                                  allowed_mentions=discord.AllowedMentions(users=True))
                    except:
                        await welcomechannel.send(embed=discord.Embed.from_dict(emb_dict),
                                                  allowed_mentions=discord.AllowedMentions(users=True))
                else:
    ...
    async def on_member_remove(self, member):
        ...
        await self.bot.db.execute("DELETE FROM warnings WHERE user_id = $1 AND guild_id = $2", member.id,
                                  member.guild.id)
        await self.bot.db.execute("DELETE FROM autowarns WHERE user_id = $1 AND guild_id = $2", member.id,
                                  member.guild.id)
        ...
        if db_check2 is not None:
            ...
            logchannel = self.bot.get_channel(db_check2)
            embed = discord.Embed(
                color=discord.Colour.from_rgb(250,0,0), description=f"<:check:784187150660665384> Member left",
                timestamp=datetime.datetime.now())
            # embed.set_author(icon_url=member.avatar_url)
        ...
        if moderation is not None:
            ...
            if deleted and (datetime.utcnow() - checks[0].created_at).total_seconds() < 5:
                ...
                embed = discord.Embed(
                    ...
                    description=f"<:check:784187150660665384> Member kicked `[#{casenum}]`", timestamp=datetime.datetime.now())
                # embed.set_author(icon_url=member.avatar_url)
        ...
        if db_check1 is not None:
            ...
            if db_check1['message'] and not db_check1['embed']:
                ...
                leavemessage = leavemessage.replace("{{member.name}}",
                                                    discord.utils.escape_markdown(member.name, as_needed=True))
                ...
                leavemessage = f"<:check:784187150660665384> {member.mention} left the server... There are {member.guild.member_count} members left in the server."
            ...
            try:
                if db_check1['embed']:
                    try:
                        await leavechannel.send(content=emb_dict['plainText'], embed=discord.Embed.from_dict(emb_dict),
                                                allowed_mentions=discord.AllowedMentions(users=True))
                    except:
                        await leavechannel.send(embed=discord.Embed.from_dict(emb_dict),
                                                allowed_mentions=discord.AllowedMentions(users=True))
                else:
    ...
    async def on_member_update(self, before, after):
        ...
        if before.nick != after.nick:
            try:
                ...
                deleted = ""
            e = discord.Embed(
                color=discord.Colour.from_rgb(250,0,0), description=f"<:members:784814520727240724> Nickname changed",
                timestamp=datetime.datetime.now())
        ...
        for guild in self.bot.guilds:
            if before in guild.members:
                ...
                if before.avatar != after.avatar:
                    e = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                                      title=f"<:members:784814520727240724> Avatar updated",
                                      timestamp=datetime.datetime.now())
                ...
                if before.name != after.name:
                    e = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                                      title=f"<:members:784814520727240724> Username updated",
                                      description=f"**{before.name}** changed his username to **{after.name}**",
                                      timestamp=datetime.datetime.now())
                    # e.set_author(name=after, icon_url=after.avatar_url)
                    e.set_footer(text=f"User ID: {after.id}")
                    try:
    ...
    async def on_member_ban(self, guild, user):
        ...
        embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                              description=f":check:784187150660665384 Member banned! `[#{casenum}]`",
                              timestamp=datetime.datetime.now())
    ...
    async def on_member_unban(self, guild, user):
        ...
        embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                              description=f":check:784187150660665384 Member unbanned! `[#{casenum}]`",
                              timestamp=datetime.datetime.now())
    ...
    async def on_voice_state_update(self, member, before, after):
        ...
        if before.mute != after.mute:
            if after.mute is False:
                ...
                mt = "muted"
            embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                                  description=f"<:members:784814520727240724> Member was voice {mt}! `[#{casenum}]`",
                                  timestamp=datetime.datetime.now())
    ...
    async def on_guild_update(self, before, after):
        ...
        if before.name != after.name:
            embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                                  description=f"<:members:784814520727240724> Guild name was changed!",
                                  timestamp=datetime.datetime.now())
        ...
        if before.region != after.region:
            embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                                  description=f"<:members:784814520727240724> Guild region was changed!",
                                  timestamp=datetime.datetime.now())
        ...
        if before.afk_channel != after.afk_channel:
            embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                                  description=f"<:members:784814520727240724> Guild afk channel was changed!",
                                  timestamp=datetime.datetime.now())
        ...
        if before.icon_url != after.icon_url:
            embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                                  description=f"<:members:784814520727240724> Guild icon was changed!",
                                  timestamp=datetime.datetime.now())
        ...
        if before.mfa_level != after.mfa_level:
            embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                                  description=f"<:members:784814520727240724> Guild multifactor authentication (MFA) was changed!",
                                  timestamp=datetime.datetime.now())
        ...
        if before.verification_level != after.verification_level:
            embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                                  description=f"<:members:784814520727240724> Guild verification level was changed!",
                                  timestamp=datetime.datetime.now())
        ...
        if before.default_notifications != after.default_notifications:
            embed = discord.Embed(color=discord.Colour.from_rgb(250,0,0),
                                  description=f"<:members:784814520727240724> Guild default notifications were changed!",
                                  timestamp=datetime.datetime.now())
            embed.add_field(name="Notifications:",
                            value=f"{before.default_notifications.name} → {after.default_notifications.name}")
        ...
        if not nick[0].isalnum():
            ...
            if not nick[0].isalnum():
                try:
                    ...
                    embed = discord.Embed(
                        color=discord.Colour.from_rgb(250,0,0),
                        description=f"<:members:784814520727240724> Member dehoisted `[#{casenum}]`",
                        timestamp=datetime.datetime.now())
